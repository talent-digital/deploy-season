...
const delayAsyncDestroy = __nccwpck_require__(9904);
...
const QuickLRU = __nccwpck_require__(9324);
const {Agent, globalAgent} = __nccwpck_require__(1840);
const Http2ClientRequest = __nccwpck_require__(2223);
const calculateServerName = __nccwpck_require__(9448);
const delayAsyncDestroy = __nccwpck_require__(9904);
...
const {Agent, globalAgent} = __nccwpck_require__(1840);
const IncomingMessage = __nccwpck_require__(3766);
const proxyEvents = __nccwpck_require__(8963);
const {
	ERR_INVALID_ARG_TYPE,
	ERR_INVALID_PROTOCOL,
	ERR_HTTP_HEADERS_SENT
} = __nccwpck_require__(5050);
const validateHeaderName = __nccwpck_require__(2661);
const validateHeaderValue = __nccwpck_require__(8294);
const proxySocketHandler = __nccwpck_require__(2739);
...
const ClientRequest = __nccwpck_require__(2223);
const IncomingMessage = __nccwpck_require__(3766);
const auto = __nccwpck_require__(1590);
const {
	HttpOverHttp2,
	HttpsOverHttp2
} = __nccwpck_require__(8930);
const Http2OverHttp2 = __nccwpck_require__(6499);
const {
	Http2OverHttp,
	Http2OverHttps
} = __nccwpck_require__(1717);
const validateHeaderName = __nccwpck_require__(2661);
const validateHeaderValue = __nccwpck_require__(8294);
...
const getAuthorizationHeaders = __nccwpck_require__(5995);
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const Http2OverHttpX = __nccwpck_require__(5340);
const getAuthorizationHeaders = __nccwpck_require__(5995);
...
// eslint-disable-next-line node/prefer-global/url
const {URL} = __nccwpck_require__(7310);
const checkType = __nccwpck_require__(4392);
...
const {ERR_HTTP2_NO_SOCKET_MANIPULATION} = __nccwpck_require__(5050);
...
const {ERR_INVALID_HTTP_TOKEN} = __nccwpck_require__(5050);
const isRequestPseudoHeader = __nccwpck_require__(9243);
...
/* harmony export */ });
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(742);
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "C": () => (/* binding */ deployArticles)
/* harmony export */ });
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(7147);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__nccwpck_require__.n(fs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var yaml_front_matter__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(3612);
/* harmony import */ var yaml_front_matter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__nccwpck_require__.n(yaml_front_matter__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(9093);
...
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(742);





const { readFile, readdir } = fs__WEBPACK_IMPORTED_MODULE_0__.promises;
/**
...
const deployArticles = async ({ authorization, baseUrl, rootPath, }) => {
    try {
        ...
        for (const file of mdFiles) {
            const content = await readFile((0,path__WEBPACK_IMPORTED_MODULE_2__.join)(path, file), {
                encoding: "utf-8",
            });
            const article = yaml_front_matter__WEBPACK_IMPORTED_MODULE_1__.loadFront(content);
            if (serverArticles.some((a) => a.title === article.title)) {
                _actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Article ${article.title} already exists on the server, skipping`);
                continue;
            }
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_3__.setFailed(JSON.stringify(e));
    }
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.info("\nArticles deploy completed\n");
};
const uploadImage = async (article, authorization, baseUrl, fileName, rootPath) => {
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Uploading image ${fileName}`);
    const formData = new FormData();
    const blob = await getBlobFromFilePath((0,path__WEBPACK_IMPORTED_MODULE_2__.join)(rootPath, article.teaser));
    ...
    try {
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Uploaded ${fileName} successfully\n`);
    }
    catch (error) {
        if (error.response) {
            _actions_core__WEBPACK_IMPORTED_MODULE_3__.setFailed(`Error response from server: ${error.response.body}`);
        }
        else {
            _actions_core__WEBPACK_IMPORTED_MODULE_3__.setFailed(`Request error: ${error}`);
        }
        throw error;
    }
};
const uploadArticle = async (article, authorization, baseUrl, fileName) => {
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Deploying article ${JSON.stringify(article)}\n`);
    ...
    await got__WEBPACK_IMPORTED_MODULE_4__/* ["default"].post */ .ZP.post(`${baseUrl}/api/v1/articles`, {
        headers: {
            authorization,
        },
        json,
...
const getServerArticles = async (authorization, baseUrl) => {
    return await got__WEBPACK_IMPORTED_MODULE_4__/* ["default"].get */ .ZP.get(`${baseUrl}/api/v1/articles`, {
        headers: {
            authorization,
        },
        searchParams: {
...
const getBlobFromFilePath = async (filePath) => {
    try {
        const absolutePath = (0,path__WEBPACK_IMPORTED_MODULE_2__.join)(filePath);
        const fileBuffer = await readFile(absolutePath);
        return new Blob([fileBuffer]);
    }
    catch (error) {
        _actions_core__WEBPACK_IMPORTED_MODULE_3__.setFailed(`Error reading file: ${error}`);
        throw error;
    }
};
...
// EXTERNAL MODULE: ./node_modules/.pnpm/yaml@2.4.5/node_modules/yaml/dist/index.js
var dist = __nccwpck_require__(8034);
// EXTERNAL MODULE: external "util"
var external_util_ = __nccwpck_require__(3837);
var external_util_default = /*#__PURE__*/__nccwpck_require__.n(external_util_);
// EXTERNAL MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/index.js + 51 modules
var source = __nccwpck_require__(742);
...
const deploySeason = async ({ repositoryId, baseUrl, authorization, rootPath, }) => {
    let path = "";
    const path1 = (0,external_path_.join)(rootPath, "season.yml");
    const path2 = (0,external_path_.join)(rootPath, "season.yaml");
    if ((0,external_fs_.existsSync)(path1)) {
        path = path1;
    }
    else if ((0,external_fs_.existsSync)(path2)) {
        path = path2;
    }
    else {
        throw new Error(`season.yaml or season.yml don't exist at specified path: ${rootPath}`);
    }
    const season = (0,dist/* parse */.Qc)(await (0,promises_namespaceObject.readFile)(path, "utf-8"));
    const json = {
        ...season,
    ...
    try {
        await source/* default.post */.ZP.post(`${baseUrl}/api/v1/season`, {
            headers: {
                authorization,
            },
            json,
...
/* harmony import */ var _deploy_season__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(8219);
/* harmony import */ var _deploy_articles__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(9374);
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(9093);
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__nccwpck_require__.n(_actions_core__WEBPACK_IMPORTED_MODULE_3__);
...
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Base URL: ${baseUrl}`);
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Environment: ${environment}`);
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`Domain: ${domain}`);
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info(`RootPath: ${rootPath}`);
...
await (0,_deploy_season__WEBPACK_IMPORTED_MODULE_1__/* .deploySeason */ .t)({
    repositoryId,
    baseUrl,
    authorization,
    rootPath,
});
await (0,_deploy_articles__WEBPACK_IMPORTED_MODULE_2__/* .deployArticles */ .C)({
    authorization,
    baseUrl,
...
var identity = __nccwpck_require__(9745);
var Scalar = __nccwpck_require__(877);
var YAMLMap = __nccwpck_require__(1302);
var YAMLSeq = __nccwpck_require__(5024);
var resolveBlockMap = __nccwpck_require__(7648);
var resolveBlockSeq = __nccwpck_require__(4829);
var resolveFlowCollection = __nccwpck_require__(772);
...
var Document = __nccwpck_require__(5350);
var composeNode = __nccwpck_require__(5586);
var resolveEnd = __nccwpck_require__(1744);
var resolveProps = __nccwpck_require__(3206);
...
var Alias = __nccwpck_require__(6781);
var composeCollection = __nccwpck_require__(9901);
var composeScalar = __nccwpck_require__(5363);
var resolveEnd = __nccwpck_require__(1744);
var utilEmptyScalarPosition = __nccwpck_require__(1960);
...
var identity = __nccwpck_require__(9745);
var Scalar = __nccwpck_require__(877);
var resolveBlockScalar = __nccwpck_require__(5190);
var resolveFlowScalar = __nccwpck_require__(6009);
...
var directives = __nccwpck_require__(6573);
var Document = __nccwpck_require__(5350);
var errors = __nccwpck_require__(9109);
var identity = __nccwpck_require__(9745);
var composeDoc = __nccwpck_require__(5587);
var resolveEnd = __nccwpck_require__(1744);
...
var Pair = __nccwpck_require__(6924);
var YAMLMap = __nccwpck_require__(1302);
var resolveProps = __nccwpck_require__(3206);
var utilContainsNewline = __nccwpck_require__(2282);
var utilFlowIndentCheck = __nccwpck_require__(4147);
var utilMapIncludes = __nccwpck_require__(764);
...
var Alias = __nccwpck_require__(6781);
var Collection = __nccwpck_require__(2255);
var identity = __nccwpck_require__(9745);
var Pair = __nccwpck_require__(6924);
var toJS = __nccwpck_require__(8454);
var Schema = __nccwpck_require__(2351);
var stringifyDocument = __nccwpck_require__(6786);
var anchors = __nccwpck_require__(3547);
var applyReviver = __nccwpck_require__(183);
var createNode = __nccwpck_require__(9048);
var directives = __nccwpck_require__(6573);
...
var identity = __nccwpck_require__(9745);
var visit = __nccwpck_require__(275);
...
var composer = __nccwpck_require__(4758);
var Document = __nccwpck_require__(5350);
var Schema = __nccwpck_require__(2351);
var errors = __nccwpck_require__(9109);
var Alias = __nccwpck_require__(6781);
...
var YAMLMap = __nccwpck_require__(1302);
var YAMLSeq = __nccwpck_require__(5024);
var cst = __nccwpck_require__(2794);
var lexer = __nccwpck_require__(224);
var lineCounter = __nccwpck_require__(8330);
var parser = __nccwpck_require__(123);
var publicApi = __nccwpck_require__(3296);
var visit = __nccwpck_require__(275);
...
var visit = __nccwpck_require__(275);
var identity = __nccwpck_require__(9745);
var Node = __nccwpck_require__(3365);
var toJS = __nccwpck_require__(8454);
...
var createNode = __nccwpck_require__(9048);
var stringifyPair = __nccwpck_require__(1275);
var addPairToJSMap = __nccwpck_require__(7277);
var identity = __nccwpck_require__(9745);
...
var stringifyCollection = __nccwpck_require__(6695);
var addPairToJSMap = __nccwpck_require__(7277);
var Collection = __nccwpck_require__(2255);
var identity = __nccwpck_require__(9745);
var Pair = __nccwpck_require__(6924);
...
var log = __nccwpck_require__(5926);
var stringify = __nccwpck_require__(2226);
var identity = __nccwpck_require__(9745);
var Scalar = __nccwpck_require__(877);
var toJS = __nccwpck_require__(8454);
...
var resolveFlowScalar = __nccwpck_require__(6009);
var errors = __nccwpck_require__(9109);
var stringifyString = __nccwpck_require__(3639);
...
var cstScalar = __nccwpck_require__(5129);
var cstStringify = __nccwpck_require__(5472);
var cstVisit = __nccwpck_require__(170);
...
var identity = __nccwpck_require__(9745);
var map = __nccwpck_require__(6062);
var seq = __nccwpck_require__(3560);
var string = __nccwpck_require__(3288);
var tags = __nccwpck_require__(5795);
...
var Scalar = __nccwpck_require__(877);
var stringifyNumber = __nccwpck_require__(1205);
...
var map = __nccwpck_require__(6062);
var _null = __nccwpck_require__(2399);
var seq = __nccwpck_require__(3560);
var string = __nccwpck_require__(3288);
var bool = __nccwpck_require__(9418);
var float = __nccwpck_require__(9253);
var int = __nccwpck_require__(8092);
...
var float = __nccwpck_require__(9253);
var int = __nccwpck_require__(8092);
var schema = __nccwpck_require__(2764);
var schema$1 = __nccwpck_require__(2023);
var binary = __nccwpck_require__(8573);
var omap = __nccwpck_require__(1852);
var pairs = __nccwpck_require__(3845);
var schema$2 = __nccwpck_require__(6282);
var set = __nccwpck_require__(8724);
var timestamp = __nccwpck_require__(5254);
...
var string = __nccwpck_require__(3288);
var binary = __nccwpck_require__(8573);
var bool = __nccwpck_require__(7658);
var float = __nccwpck_require__(4650);
var int = __nccwpck_require__(7618);
var omap = __nccwpck_require__(1852);
var pairs = __nccwpck_require__(3845);
var set = __nccwpck_require__(8724);
var timestamp = __nccwpck_require__(5254);
...
var anchors = __nccwpck_require__(3547);
var identity = __nccwpck_require__(9745);
var stringifyComment = __nccwpck_require__(4613);
var stringifyString = __nccwpck_require__(3639);
...
var Scalar = __nccwpck_require__(877);
var foldFlowLines = __nccwpck_require__(5403);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@sindresorhus+is@5.6.0/node_modules/@sindresorhus/is/dist/index.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/errors.js
...
var src = __nccwpck_require__(8534);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/isFunction.js
const isFunction = (value) => (typeof value === "function");

;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/isFormData.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/getStreamIterator.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/createBoundary.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/normalizeValue.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/isPlainObject.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/proxyHeaders.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/escapeName.js
const escapeName = (name) => String(name)
    .replace(/\r/g, "%0D")
    .replace(/\n/g, "%0A")
    .replace(/"/g, "%22");

;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/util/isFile.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/form-data-encoder@2.1.4/node_modules/form-data-encoder/lib/FormDataEncoder.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/is-form-data.js

function is_form_data_isFormData(body) {
    return dist.nodeStream(body) && dist.function_(body.getBoundary);
}

;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/get-body-size.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/proxy-events.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/unhandle.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/timed-out.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/url-to-options.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/weakable-map.js
class WeakableMap {
    constructor() {
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/calculate-retry-delay.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/parse-link-header.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/options.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/response.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/is-client-request.js
function isClientRequest(clientRequest) {
    return clientRequest.writable && !clientRequest.writableEnded;
}
/* harmony default export */ const is_client_request = (isClientRequest);

;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/utils/is-unix-socket-url.js
// eslint-disable-next-line @typescript-eslint/naming-convention
function isUnixSocketURL(url) {
    return url.protocol === 'unix:' || url.hostname === 'unix';
}

;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/core/index.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/as-promise/types.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/as-promise/index.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/create.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/got@12.6.1/node_modules/got/dist/source/index.js
