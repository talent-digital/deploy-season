...
/* harmony export */ });
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(3909);
...
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(3909);
const { readFile, readdir } = (__nccwpck_require__(7147).promises);
const yamlFront = __nccwpck_require__(3612);



const deployArticles = async ({ authorization, baseUrl, rootPath, }) => {
    try {
        const path = (0,path__WEBPACK_IMPORTED_MODULE_0__.join)(rootPath, "articles");
        const files = await readdir(path);
        const mdFiles = files.filter((file) => file.endsWith(".md"));
        _actions_core__WEBPACK_IMPORTED_MODULE_1__.info(`Found ${mdFiles.length} files`);
        const serverArticles = (await got__WEBPACK_IMPORTED_MODULE_2__/* ["default"].get */ .ZP.get(`${baseUrl}/api/v1/articles`, {
            headers: {
                authorization,
            },
            searchParams: {
        ...
        for (const file of mdFiles) {
            const content = await readFile((0,path__WEBPACK_IMPORTED_MODULE_0__.join)(path, file), {
                encoding: "utf-8",
            });
            const article = yamlFront.loadFront(content);
            if (serverArticles.some((a) => a.title === article.title)) {
                _actions_core__WEBPACK_IMPORTED_MODULE_1__.info(`Article ${article.title} already exists on the server, skipping`);
                continue;
            }
            _actions_core__WEBPACK_IMPORTED_MODULE_1__.info(`Deploying article ${JSON.stringify(article)}\n`);
            const json = {
            ...
            await got__WEBPACK_IMPORTED_MODULE_2__/* ["default"].post */ .ZP.post(`${baseUrl}/api/v1/articles`, {
                headers: {
                    authorization,
                },
                json,
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_1__.setFailed(JSON.stringify(e));
    }
...
/* harmony import */ var _deploy_articles__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(9374);
