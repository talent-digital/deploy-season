...
const getAuthorizationHeader = async (domain, environmemt, clientId, clientSecret) => {
    const { token_type, access_token } = await got_dist_source.post(`https://${environmemt}.${domain}/auth/realms/talentdigital-${environmemt}/protocol/openid-connect/token`, {
        form: {
